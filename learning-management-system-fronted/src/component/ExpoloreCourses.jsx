...
function ExploreCourses(){
    return (
        <div className='w-full min-h-[50vh] lg:h-[50vh] flex flex-col lg:flex-row items-center justify-center gap-4 px-[30px]'>
            ...
            {/* left/top div */}
            <div className='w-full lg:w-[350px] lg:h-full h-[400px] flex flex-col items-start justify-center gap-1 md:px-[40px] px-[20px]'>
                <span className='text-[35px] font-semibold'>Explore</span>
                <span className='text-[35px] font-semibold'>our Courses</span>
                <p className='text-[17px]'>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et eaque non at voluptates nam enim tenetur odio iusto, nemo cupiditate?
                </p>
                <button className='px-[20px] py-[10px] border-2 bg-black border-white text-white rounded-[10px] text-[18px] font-light flex gap-2 mt-[40px] lg:mb-[20px]  cursor-pointer '>
                    Explore Courses <SiViaplay className='w-[30px] h-[30px] fill-white'/>
                </button>
            </div>

            {/* right/top div */}
            <div className='w-[720px] max-w-[90%] lg:h-[300px] md:min-h-[300px] flex items-center justify-center lg:gap-[60px] gap-[50px] flex-wrap mb-[50px] lg:mb-[50px] '>
                ...
                <div className='w-[100px] h-[130px] font-light text-[13px] flex flex-col gap-3 text-center '>
                    <div className='w-[100px] h-[90px] bg-[#b9fbe0] rounded-lg flex items-center justify-center'>
