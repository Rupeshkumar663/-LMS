...
function CardPage(){
    ...
    return (
        <div className="relative flex items-center justify-center flex-col">
         <h1 className="md:text-[45px] text-[30px] font-semibold text-center mt-[30px] px-[20px] ">Our Popoular Courses</h1>
         ...
         <div className="w-[100%] min-h-[100vh] flex items-center justify-center  gap-[50px] lg:p-[50px] md:p-[30px] p-[10px] mb-[40px]">
            {
