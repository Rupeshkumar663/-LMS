...
import ExploreCourses from '../component/ExpoloreCourses';
    ...
    <div className='w-[100%] overflow-hidden'>
      <div className='w-[100%] lg:h-[140vh] h-[70vh] relative'>
        ...
        <div className='absolute lg:top-[30%] top-[75%] md:top-[80%] w-[100%] flex items-center justify-center gap-3 flex-wrap'>
          ...
          <button className='px-[20px] py-[10px] lg:bg-white bg-black  lg:text-black text-white rounded-[10px] text-[18px] font-light flex gap-2 cursor-pointer items-center justify-center'>Search with Ai <img src={ai} className='w-[30px] h-[30px] rounded-full hidden lg:block 'alt="" />
