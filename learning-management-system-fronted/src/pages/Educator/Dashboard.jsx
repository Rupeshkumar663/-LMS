...
function Dashboard(){
    ...
    return (
        <div className='flex ml-[6%] min-h-screen bg-gray-100'>
            <FaArrowLeftLong className="w-[22px] absolute top-[10px] ledt-[10%] h-[22px] cursor-pointer" onClick={()=>navigate("/")}/>
          <div className='w-full px-6 py-10 bg-gray-50 space-y-10 '>
            {/*main section*/}
             <div className='max-w-5xl mt-auto bg-white rounded-xl shadow-md p-6 flex flex-col md:flex-row items-center gap-6'>
